...
import com.mashape.unirest.http.exceptions.UnirestExcept;
                ...
                try {
                    ...
                    if (cbcuisine1.getSelectedIndex() >= 1) {
                        ...
                        while (st.hasMoreTokens()) {
                            ...
                            URL url = new URL("http://localhost:80/GetResource/" + photo);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    HttpResponse<String> res = Unirest.get("http://localhost:80/getfooditems")
                            ...
                            public void mouseClicked(MouseEvent e) {
                                ...
                                if (result.equals("") == false) {
                                    try {
                                        ...
                                        int oldqty = 0;
                                        int index = 0;
                                        for (int k = 0; k <= globalclass.cartal.size() - 1; k++) {
                                            if (globalclass.cartal.get(k).itemname.equals(itemname)) {
                                                flag = true;
                                                oldqty = globalclass.cartal.get(k).quantity;
                                                break;
                                            }
                                            index++;
                                        }
                                        if (flag == false) {
                                            globalclass.cartal.add(obj);
                                        } else {
                                            int newqty = oldqty + qty;
                                            int newprice = newqty * price;
                                            globalclass.cartal.get(index).quantity = newqty;
                                            globalclass.cartal.get(index).totalprice = newprice;
                                        }
                                        lbcartqty.setText(globalclass.cartal.size() + "");
                                        System.out.println(globalclass.cartal);
